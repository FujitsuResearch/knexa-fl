...
# Centralized KD Baseline using KNEXA-FL Codebase
# This script runs the KNEXA-FL implementation with centralized knowledge distillation strategy
...
show_usage() {
    ...
    echo ""
    echo "Centralized KD baseline using KNEXA-FL implementation"
    echo ""
    echo "OPTIONS:"
...
if [ -z "$EXPERIMENT_NAME" ]; then
    EXPERIMENT_NAME="Central_KD_${TIMESTAMP}"
fi
...
# Setup save directory - Use baselines directory for centralized KD
if [ -z "$SAVE_DIR" ]; then
...
echo "============================================================"
echo "🌐 Centralized KD Baseline (KNEXA-FL Implementation)"
echo "============================================================"
echo "📊 Configuration:"
echo "   Experiment Name: $EXPERIMENT_NAME"
echo "   Method: Centralized Knowledge Distillation"
echo "   Rounds: $ROUNDS"
echo "   Seed: $SEED"
...
echo "   ✅ CENTRALIZED Teacher Selection (not LinUCB or Random)"
echo "============================================================"

echo ""
echo "🌐 Starting Centralized KD Baseline Experiment..."
...
ARGS="$ARGS --pairing-strategy central_kd"  # KEY DIFFERENCE: Use centralized KD pairing
...
echo ""
echo "🏁 Centralized KD Baseline Experiment Completed!"
echo "============================================================"
echo "⏰ End Time: $(date)"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo ""
    echo "📊 To compare with KNEXA-FL (LinUCB) and Random P2P, run:"
    echo "   python scripts/compare_results.py --baseline central_kd --method linucb --method random"
    echo ""
...
echo ""
echo "✅ Centralized KD baseline experiment complete!"
echo "🔬 Results ready for comparison with KNEXA-FL (LinUCB) and Random P2P"
